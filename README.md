...
- [一、Git 的基础概念](#一git-的基础概念)
  - [1、什么是回溯？](#1什么是回溯)
  - [2、什么是分支？](#2什么是分支)
- [二、最常用的基础命令](#二最常用的基础命令)
  - [git init](#git-init)
  - [git add .](#git-add-)
  - [git commit -m '说明'](#git-commit--m-说明)
  - [git log](#git-log)
- [三、回溯功能 —— 时光倒流](#三回溯功能--时光倒流)
  - [1、git checkout —— 只“看”过去，不破坏未来](#1git-checkout--只看过去不破坏未来)
  - [2、git reset --hard —— 真·时光倒流（可能丢掉未来）](#2git-reset---hard--真时光倒流可能丢掉未来)
  - [3、git revert —— 反做某个存档，不改变历史](#3git-revert--反做某个存档不改变历史)
  - [结论](#结论-1)
- [四、分支基础命令](#四分支基础命令)
  - [1、查看所有分支信息](#1查看所有分支信息)
  - [2、添加分支](#2添加分支)
  - [3、删除分支](#3删除分支)
- [五、上传云端](#五上传云端)
  - [1、简单操作](#1简单操作)
  - [2、不简单操作](#2不简单操作)
    - [有哪几个选项？该如何操作？](#有哪几个选项该如何操作)
      - [1、正常的合并（推荐，最安全）](#1正常的合并推荐最安全)
      - [2、强制推送（危险！会覆盖云端）](#2强制推送危险会覆盖云端)
      - [3、如果云端是完全空的（初始化仓库但没有提交）](#3如果云端是完全空的初始化仓库但没有提交)
    - [结论](#结论-2)
