...
​         1、什么是回溯？
​         用一个“游戏存档”的比喻来理解 Git。
​         当你玩一款游戏，游戏途中每完成一个重要任务，我们都会做一次存档点，而Git的存档会比游戏当中还要高级一些，Git能够回溯到任意的存档点并且还拥有更强大的功能。
​         2、什么是分支？
...
​        在文件夹内使用该命令，该文件夹就会升级成超级无敌记忆文件夹，并且出现以下语句：
​                                  **Initialized empty Git repository in <XX路径>**
​        这个语句的意思是       **在XX路径中初始化空Git仓库**
